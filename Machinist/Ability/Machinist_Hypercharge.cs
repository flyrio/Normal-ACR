...
public class Machinist_Hypercharge : ISlotResolver
{
    ...
    public int Check()
    {
        if (Core.Me.ClassLevel == 90 && (SpellsDefine.Drill.IsReady() || SpellsDefine.AirAnchor.IsReady() ||
                                         (SpellsDefine.ChainSaw.IsReady() && !Qt.GetQt("回转飞锯")))) return -1;
        if (Core.Get<IMemApiMCH>().GetHeat() == 100)
        {
            if (Core.Me.ClassLevel == 90 &&
                (SpellsDefine.ChainSaw.GetSpell().Cooldown.TotalMilliseconds <=
                    Core.Get<IMemApiSpell>().GetGCDDuration() || SpellsDefine.ChainSaw.IsReady()) || !Qt.GetQt("回转飞锯"))
                return -1;
            if (Core.Me.ClassLevel >= 76 &&
                (SpellsDefine.AirAnchor.GetSpell().Cooldown.TotalMilliseconds <=
                    Core.Get<IMemApiSpell>().GetGCDDuration() || SpellsDefine.AirAnchor.IsReady()))
                return -2; 
            if (Core.Me.ClassLevel >= 58 &&
                (SpellsDefine.Drill.GetSpell().Cooldown.TotalMilliseconds <=
                    Core.Get<IMemApiSpell>().GetGCDDuration() || SpellsDefine.Drill.IsReady()))
                return -3; 
        }
        ...
        if (!Qt.GetQt("攒资源") && Core.Get<IMemApiMCH>().GetHeat() >= 50 && !Core.Get<IMemApiMCH>().OverHeated() && Core.Me.ClassLevel >= 30 && Core.Me.ClassLevel < 45 && SpellsDefine.Hypercharge.IsReady()
            &&
            SpellsDefine.HotShot.GetSpell().Cooldown.TotalMilliseconds >= 9000
        ...
        if (!Qt.GetQt("攒资源") && Core.Get<IMemApiMCH>().GetHeat() >= 50 && !Core.Get<IMemApiMCH>().OverHeated() && Core.Me.ClassLevel >= 45 && Core.Me.ClassLevel < 58 && SpellsDefine.Hypercharge.IsReady()
            ...
            && Core.Get<IMemApiSpell>().GetCharges(SpellsDefine.Ricochet.GetSpell().Id) < 1
            && Core.Get<IMemApiSpell>().GetElapsedGCD() < 1200
            ||
        ...
        if (!Qt.GetQt("攒资源") && Core.Get<IMemApiMCH>().GetHeat() >= 50 && !Core.Get<IMemApiMCH>().OverHeated() && Core.Me.ClassLevel >= 58 && Core.Me.ClassLevel < 74 && SpellsDefine.Hypercharge.IsReady()
            &&
            (SpellsDefine.HotShot.GetSpell().Cooldown.TotalMilliseconds >= 9000 && SpellsDefine.Drill.GetSpell().Cooldown.TotalMilliseconds >= 9000 )
        ...
        if (!Qt.GetQt("攒资源") && Core.Get<IMemApiMCH>().GetHeat() >= 50 && !Core.Get<IMemApiMCH>().OverHeated() && Core.Me.ClassLevel >= 76 && Core.Me.ClassLevel < 90 && SpellsDefine.Hypercharge.IsReady()
            &&
            (SpellsDefine.Drill.GetSpell().Cooldown.TotalMilliseconds >= 9000 && SpellsDefine.AirAnchor.GetSpell().Cooldown.TotalMilliseconds >= 9000 )
        ...
        if (!Qt.GetQt("攒资源") && Core.Get<IMemApiMCH>().GetHeat() >= 50 && !Core.Get<IMemApiMCH>().OverHeated() && Core.Me.ClassLevel == 90 && SpellsDefine.Hypercharge.IsReady()
            &&
            (SpellsDefine.Drill.GetSpell().Cooldown.TotalMilliseconds >= 9000 && SpellsDefine.AirAnchor.GetSpell().Cooldown.TotalMilliseconds >= 9000  && SpellsDefine.ChainSaw.GetSpell().Cooldown.TotalMilliseconds >= 9000)
            && !SpellsDefine.Drill.IsReady() && !SpellsDefine.AirAnchor.IsReady() && (!SpellsDefine.ChainSaw.IsReady() || !Qt.GetQt("回转飞锯"))
            && (SpellsDefine.Wildfire.GetSpell().Cooldown.TotalMilliseconds >= 20000 || SpellsDefine.Wildfire.IsReady())
            && Core.Get<IMemApiSpell>().GetCharges(SpellsDefine.Ricochet.GetSpell().Id) < 2
            && Core.Get<IMemApiSpell>().GetElapsedGCD() < 1200
            ||
